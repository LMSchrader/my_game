...
export function createOutline(sizeMultiplier: number, width: number, color: number): Graphics {
    const outline = new Graphics()
    const corners: PixelCoordinates[] = getHexCorners({x: 0, y: 0}, HEX_SIZE * sizeMultiplier)
