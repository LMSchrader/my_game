...
import {Colors, DEFAULT_MOVEMENT_POINTS, DEFAULT_SPEED, DEFAULT_SPRITE_SCALE} from '../config/config.ts'
...
export class CharacterEntity extends Container implements Character {
    ...
    private createTeamBorder(): void {
        this.teamBorder = createOutline(0.95, 3, this.team === Team.TeamA ? Colors.CHARACTER_DEFAULT : Colors.ENEMY)
