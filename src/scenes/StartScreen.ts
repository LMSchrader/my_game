...
import {FONTSIZE_BIG, FONTSIZE_MEDIUM, GAME_TITLE, PLAY, TEXT_COLOR_WHITE} from "../config/config.ts";
...
export class StartScreen extends Container implements Scene {
    ...
    private createPlayButton(): void {
        ...
        this.playButton.onPress.connect(() => this.sceneManager.switchScene(SceneType.GAME));
